...
- **Comments are the last resort.** If the code needs prose to be understood, rename a thing or extract a function first. Reserve comments for _why_, not _what_.
